...
import com.tsoft.dictionary.api.BaseFileReader;
...
public class TxtBaseFileReader implements BaseFileReader {
    private Logger logger = Logger.getLogger(TxtBaseFileReader.class.getName());
    ...
    public TxtBaseFileReader(String fileName) throws FileNotFoundException, IOException {
        this(fileName, 8192);
    }

    public TxtBaseFileReader(String fileName, int blockSize) throws FileNotFoundException, IOException {
